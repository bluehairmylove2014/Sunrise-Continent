...
import { AuthProviderType } from "../lib/auth/process/provider/AuthProvider";
import { CartProvider } from "../lib/cart/process/provider";
import { CartProviderType } from "../lib/cart/process/provider/CartProvider";
...
type ProviderKeyConfig = "auth" | "cart";
type ProviderType = AuthProviderType | CartProviderType;
type ProviderConfig = {
  key: ProviderKeyConfig;
  provider: React.FC<ProviderType>;
  isActive: boolean;
...
export const providerConfig: ProviderConfig[] = [
  {
    key: "auth",
    provider: AuthProvider as React.FC<ProviderType>,
    isActive: true,
    isNeedAccessToken: false,
  },
  {
    key: "cart",
    provider: CartProvider as React.FC<ProviderType>,
    isActive: true,
