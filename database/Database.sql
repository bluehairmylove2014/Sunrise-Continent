...
(
	...
	PRIMARY KEY (AccountId, HotelId, RoomTypeId,VoucherId,CheckIn)
)
...
ALTER TABLE BOOKING_ACCOUNT
ADD
	CONSTRAINT FK_BOOKING_ACCOUNT_VOUCHER
...
--INSERT INTO PLACE VALUES(2,N'Ha Noi');
--INSERT INTO PLACE VALUES(3,N'Hội An');
...
INSERT INTO FACILITY_CONST VALUES(1,'WORK_DESK');
INSERT INTO FACILITY_CONST VALUES(2,'SAFE');
INSERT INTO FACILITY_CONST VALUES(3,'FLAT_SCREEN_TV');
INSERT INTO FACILITY_CONST VALUES(4,'BATH_TOWEL');
INSERT INTO FACILITY_CONST VALUES(5,'REFRIGERATOR');
INSERT INTO FACILITY_CONST VALUES(6,'MINIBAR');
INSERT INTO FACILITY_CONST VALUES(7,'ELECTRIC_KETTLE');
INSERT INTO FACILITY_CONST VALUES(8,'TELEPHONE');
INSERT INTO FACILITY_CONST VALUES(9,'AIR_CONDITIONING');
INSERT INTO FACILITY_CONST VALUES(10,'CLOTHES_RACK');
INSERT INTO FACILITY_CONST VALUES(11,'HAND_WASH');

INSERT INTO FACILITY_CONST VALUES(12,'KITCHEN');
INSERT INTO FACILITY_CONST VALUES(13,'MICROWAVE');
INSERT INTO FACILITY_CONST VALUES(14,'WASHING_MACHINE');
INSERT INTO FACILITY_CONST VALUES(15,'OVEN');
INSERT INTO FACILITY_CONST VALUES(16,'ALARM_CLOCK');
INSERT INTO FACILITY_CONST VALUES(17,'OUTDOOR_FURNITURE');
INSERT INTO FACILITY_CONST VALUES(18,'KITCHEN_UTENSILS');
INSERT INTO FACILITY_CONST VALUES(19,'COOKING_STOVE');

INSERT INTO FACILITY_CONST VALUES(20,'BREAD_TOASTER');
INSERT INTO FACILITY_CONST VALUES(21,'HIGH_CHAIR_FOR_CHILDREN');
INSERT INTO FACILITY_CONST VALUES(22,'IRONING_BOARD');
INSERT INTO FACILITY_CONST VALUES(23,'ELECTRIC_FAN');
INSERT INTO FACILITY_CONST VALUES(24,'WARDROBE');
INSERT INTO FACILITY_CONST VALUES(25,'SMOKING_AREA');
INSERT INTO FACILITY_CONST VALUES(26,'DINING_AREA');
INSERT INTO FACILITY_CONST VALUES(27,'TEA/COFFEE_MAKER');
INSERT INTO FACILITY_CONST VALUES(28,'DISABLED_FACILITIES');
INSERT INTO FACILITY_CONST VALUES(29,'INTERNET');
INSERT INTO FACILITY_CONST VALUES(30,'STREAMING_SERVICES')
INSERT INTO FACILITY_CONST VALUES(31,'CARBON_MONOXIDE_DETECTOR')
INSERT INTO FACILITY_CONST VALUES(32,'FOLDING_BED');

INSERT INTO FACILITY_CONST VALUES(33, 'NON_SMOKING');

INSERT INTO FACILITY_CONST VALUES(34,'GYM');						--check 3)
INSERT INTO FACILITY_CONST VALUES(35,'SWIMMING_POOL');				--check 3 4 5 7
INSERT INTO FACILITY_CONST VALUES(36,'SPA_SAUNA');					--check
INSERT INTO FACILITY_CONST VALUES(37,'NIGHT_CLUB');					--check

--!add room service
INSERT INTO SERVICE_CONST VALUES(8,'BREAKFAST_INCLUDED');
INSERT INTO SERVICE_CONST VALUES(9,'DINNER_INCLUDED');
INSERT INTO SERVICE_CONST VALUES(12,'FREE_SNACKS');
INSERT INTO SERVICE_CONST VALUES(10,'LUNCH_INCLUDED');
INSERT INTO SERVICE_CONST VALUES(6,'AFTERNOON_TEA');

INSERT INTO SERVICE_CONST VALUES(1,'WAKE_UP_CALL');
INSERT INTO SERVICE_CONST VALUES(2,'OUTDOOR_DINING_AREA');

INSERT INTO SERVICE_CONST VALUES(3,'UNCATEGORIZED-1');
INSERT INTO SERVICE_CONST VALUES(4,'UNCATEGORIZED-2');
INSERT INTO SERVICE_CONST VALUES(5,'UNCATEGORIZED-3');
INSERT INTO SERVICE_CONST VALUES(7,'UNCATEGORIZED-4');

INSERT INTO SERVICE_CONST VALUES(11,'PET_CARE_SERVICE');
INSERT INTO SERVICE_CONST VALUES(13,'FREE_FRUIT_DAILY');
INSERT INTO SERVICE_CONST VALUES(14,'LAUNDRY_AND_IRONING_SERVICE');
...
INSERT INTO ROOM_FACILITY VALUES (1, 1, 10);
INSERT INTO ROOM_FACILITY VALUES (1, 1, 11);
INSERT INTO ROOM_FACILITY VALUES (1, 1, 32);
...
INSERT INTO ROOM_FACILITY VALUES (1, 2, 7);
INSERT INTO ROOM_FACILITY VALUES (1, 2, 8);
INSERT INTO ROOM_FACILITY VALUES (1, 2, 9);
INSERT INTO ROOM_FACILITY VALUES (1, 2, 10);
INSERT INTO ROOM_FACILITY VALUES (1, 2, 11);
INSERT INTO ROOM_FACILITY VALUES (1, 2, 32);
...
INSERT INTO ROOM_FACILITY VALUES (1, 3, 7);
INSERT INTO ROOM_FACILITY VALUES (1, 3, 8);
INSERT INTO ROOM_FACILITY VALUES (1, 3, 9);
INSERT INTO ROOM_FACILITY VALUES (1, 3, 10);
INSERT INTO ROOM_FACILITY VALUES (1, 3, 11);
INSERT INTO ROOM_FACILITY VALUES (1, 3, 32);

--! add room services
INSERT INTO ROOM_SERVICE VALUES (1, 1, 1);
INSERT INTO ROOM_SERVICE VALUES (1, 1, 3);
INSERT INTO ROOM_SERVICE VALUES (1, 1, 8);

INSERT INTO ROOM_SERVICE VALUES (1, 2, 1);
INSERT INTO ROOM_SERVICE VALUES (1, 2, 3);
INSERT INTO ROOM_SERVICE VALUES (1, 2, 5);
INSERT INTO ROOM_SERVICE VALUES (1, 2, 8);

INSERT INTO ROOM_SERVICE VALUES (1, 3, 1);
INSERT INTO ROOM_SERVICE VALUES (1, 3, 3);
...
--!add room failiti
INSERT INTO ROOM_FACILITY VALUES(2,1,12);
INSERT INTO ROOM_FACILITY VALUES(2,1,5);
INSERT INTO ROOM_FACILITY VALUES(2,1,13);
INSERT INTO ROOM_FACILITY VALUES(2,1,18);
INSERT INTO ROOM_FACILITY VALUES(2,1,7);
INSERT INTO ROOM_FACILITY VALUES(2,1,14);
INSERT INTO ROOM_FACILITY VALUES(2,1,17);
INSERT INTO ROOM_FACILITY VALUES(2,1,15);
INSERT INTO ROOM_FACILITY VALUES(2,1,19);
INSERT INTO ROOM_FACILITY VALUES(2,1,1);
INSERT INTO ROOM_FACILITY VALUES(2,1,3);
INSERT INTO ROOM_FACILITY VALUES(2,1,16);

INSERT INTO ROOM_FACILITY VALUES(2,2,12);
INSERT INTO ROOM_FACILITY VALUES(2,2,5);
INSERT INTO ROOM_FACILITY VALUES(2,2,13);
INSERT INTO ROOM_FACILITY VALUES(2,2,18);
INSERT INTO ROOM_FACILITY VALUES(2,2,7);
INSERT INTO ROOM_FACILITY VALUES(2,2,14);
INSERT INTO ROOM_FACILITY VALUES(2,2,17);
INSERT INTO ROOM_FACILITY VALUES(2,2,15);
INSERT INTO ROOM_FACILITY VALUES(2,2,19);
INSERT INTO ROOM_FACILITY VALUES(2,2,1);
INSERT INTO ROOM_FACILITY VALUES(2,2,3);
INSERT INTO ROOM_FACILITY VALUES(2,2,16);

INSERT INTO ROOM_FACILITY VALUES(2,3,12);
INSERT INTO ROOM_FACILITY VALUES(2,3,5);
INSERT INTO ROOM_FACILITY VALUES(2,3,13);
INSERT INTO ROOM_FACILITY VALUES(2,3,18);
INSERT INTO ROOM_FACILITY VALUES(2,3,7);
INSERT INTO ROOM_FACILITY VALUES(2,3,14);
INSERT INTO ROOM_FACILITY VALUES(2,3,17);
INSERT INTO ROOM_FACILITY VALUES(2,3,15);
INSERT INTO ROOM_FACILITY VALUES(2,3,19);
INSERT INTO ROOM_FACILITY VALUES(2,3,1);
INSERT INTO ROOM_FACILITY VALUES(2,3,3);
INSERT INTO ROOM_FACILITY VALUES(2,3,16);

--!add room service 
INSERT INTO ROOM_SERVICE VALUES(2,1,2);
INSERT INTO ROOM_SERVICE VALUES(2,1,11);

INSERT INTO ROOM_SERVICE VALUES(2,2,2);
INSERT INTO ROOM_SERVICE VALUES(2,2,11);

INSERT INTO ROOM_SERVICE VALUES(2,3,2);
INSERT INTO ROOM_SERVICE VALUES(2,3,11);
...
INSERT INTO ROOM_FACILITY VALUES(3,1,21);
INSERT INTO ROOM_FACILITY VALUES(3,1,5);
INSERT INTO ROOM_FACILITY VALUES(3,1,13);
INSERT INTO ROOM_FACILITY VALUES(3,1,18);
INSERT INTO ROOM_FACILITY VALUES(3,1,6);
INSERT INTO ROOM_FACILITY VALUES(3,1,7);
INSERT INTO ROOM_FACILITY VALUES(3,1,17);
INSERT INTO ROOM_FACILITY VALUES(3,1,19);
INSERT INTO ROOM_FACILITY VALUES(3,1,20);
INSERT INTO ROOM_FACILITY VALUES(3,1,26);
INSERT INTO ROOM_FACILITY VALUES(3,1,1);
INSERT INTO ROOM_FACILITY VALUES(3,1,3);
INSERT INTO ROOM_FACILITY VALUES(3,1,16);
INSERT INTO ROOM_FACILITY VALUES(3,1,22);
INSERT INTO ROOM_FACILITY VALUES(3,1,23);

INSERT INTO ROOM_FACILITY VALUES(3,2,12);
INSERT INTO ROOM_FACILITY VALUES(3,2,21);
INSERT INTO ROOM_FACILITY VALUES(3,2,5);
INSERT INTO ROOM_FACILITY VALUES(3,2,13);
INSERT INTO ROOM_FACILITY VALUES(3,2,18);
INSERT INTO ROOM_FACILITY VALUES(3,2,6);
INSERT INTO ROOM_FACILITY VALUES(3,2,7);
INSERT INTO ROOM_FACILITY VALUES(3,2,17);
INSERT INTO ROOM_FACILITY VALUES(3,2,19);
INSERT INTO ROOM_FACILITY VALUES(3,2,20);
INSERT INTO ROOM_FACILITY VALUES(3,2,26);
INSERT INTO ROOM_FACILITY VALUES(3,2,1);
INSERT INTO ROOM_FACILITY VALUES(3,2,3);
INSERT INTO ROOM_FACILITY VALUES(3,2,16);
INSERT INTO ROOM_FACILITY VALUES(3,2,22);
INSERT INTO ROOM_FACILITY VALUES(3,2,23);

INSERT INTO ROOM_FACILITY VALUES(3,3,12);
INSERT INTO ROOM_FACILITY VALUES(3,3,21);
INSERT INTO ROOM_FACILITY VALUES(3,3,5);
INSERT INTO ROOM_FACILITY VALUES(3,3,13);
INSERT INTO ROOM_FACILITY VALUES(3,3,18);
INSERT INTO ROOM_FACILITY VALUES(3,3,6);
INSERT INTO ROOM_FACILITY VALUES(3,3,7);
INSERT INTO ROOM_FACILITY VALUES(3,3,17);
INSERT INTO ROOM_FACILITY VALUES(3,3,19);
INSERT INTO ROOM_FACILITY VALUES(3,3,20);
INSERT INTO ROOM_FACILITY VALUES(3,3,26);
INSERT INTO ROOM_FACILITY VALUES(3,3,1);
INSERT INTO ROOM_FACILITY VALUES(3,3,3);
INSERT INTO ROOM_FACILITY VALUES(3,3,16);
INSERT INTO ROOM_FACILITY VALUES(3,3,22);
INSERT INTO ROOM_FACILITY VALUES(3,3,23);

--!ADD ROOM SERVICES
INSERT INTO ROOM_SERVICE VALUES(3,1,2);
INSERT INTO ROOM_SERVICE VALUES(3,1,4);
INSERT INTO ROOM_SERVICE VALUES(3,1,14);

INSERT INTO ROOM_SERVICE VALUES(3,2,2);
INSERT INTO ROOM_SERVICE VALUES(3,2,4);
INSERT INTO ROOM_SERVICE VALUES(3,2,14);

INSERT INTO ROOM_SERVICE VALUES(3,3,2);
INSERT INTO ROOM_SERVICE VALUES(3,3,4);
INSERT INTO ROOM_SERVICE VALUES(3,3,14);
...
--!ADD ROOM FACUILITY
INSERT INTO ROOM_FACILITY VALUES(4,1,7);
INSERT INTO ROOM_FACILITY VALUES(4,1,9);
INSERT INTO ROOM_FACILITY VALUES(4,1,22);
INSERT INTO ROOM_FACILITY VALUES(4,1,4);
INSERT INTO ROOM_FACILITY VALUES(4,1,24);
INSERT INTO ROOM_FACILITY VALUES(4,1,11);
INSERT INTO ROOM_FACILITY VALUES(4,1,10);

INSERT INTO ROOM_FACILITY VALUES(4,2,7);
INSERT INTO ROOM_FACILITY VALUES(4,2,9);
INSERT INTO ROOM_FACILITY VALUES(4,2,22);
INSERT INTO ROOM_FACILITY VALUES(4,2,4);
INSERT INTO ROOM_FACILITY VALUES(4,2,24);
INSERT INTO ROOM_FACILITY VALUES(4,2,11);
INSERT INTO ROOM_FACILITY VALUES(4,2,10);

INSERT INTO ROOM_FACILITY VALUES(4,3,7);
INSERT INTO ROOM_FACILITY VALUES(4,3,9);
INSERT INTO ROOM_FACILITY VALUES(4,3,22);
INSERT INTO ROOM_FACILITY VALUES(4,3,4);
INSERT INTO ROOM_FACILITY VALUES(4,3,24);
INSERT INTO ROOM_FACILITY VALUES(4,3,11);
INSERT INTO ROOM_FACILITY VALUES(4,3,10);

--!ADD ROOM SERVICE
INSERT INTO ROOM_SERVICE VALUES(4,1,6);
INSERT INTO ROOM_SERVICE VALUES(4,1,7);
INSERT INTO ROOM_SERVICE VALUES(4,1,14);

INSERT INTO ROOM_SERVICE VALUES(4,2,6);
INSERT INTO ROOM_SERVICE VALUES(4,2,7);
INSERT INTO ROOM_SERVICE VALUES(4,2,14);

INSERT INTO ROOM_SERVICE VALUES(4,3,6);
INSERT INTO ROOM_SERVICE VALUES(4,3,7);
INSERT INTO ROOM_SERVICE VALUES(4,3,14);
...
INSERT INTO ROOM_FACILITY VALUES(5,1,24);
INSERT INTO ROOM_FACILITY VALUES(5,1,9);
INSERT INTO ROOM_FACILITY VALUES(5,1,10);
...
INSERT INTO ROOM_FACILITY VALUES(5,2,24);
INSERT INTO ROOM_FACILITY VALUES(5,2,9);
INSERT INTO ROOM_FACILITY VALUES(5,2,10);
INSERT INTO ROOM_FACILITY VALUES(5,2,25);
...
INSERT INTO ROOM_FACILITY VALUES(5,3,24);
INSERT INTO ROOM_FACILITY VALUES(5,3,9);
INSERT INTO ROOM_FACILITY VALUES(5,3,10);
INSERT INTO ROOM_FACILITY VALUES(5,3,25);


--!ADD ROOM SERVICE
INSERT INTO ROOM_SERVICE VALUES(5,1,8);
INSERT INTO ROOM_SERVICE VALUES(5,1,14);

INSERT INTO ROOM_SERVICE VALUES(5,2,8);
INSERT INTO ROOM_SERVICE VALUES(5,2,14);

INSERT INTO ROOM_SERVICE VALUES(5,3,8);
INSERT INTO ROOM_SERVICE VALUES(5,3,14);
...
--!ADD ROOM FACILITY
INSERT INTO ROOM_FACILITY VALUES(6,1,19);
INSERT INTO ROOM_FACILITY VALUES(6,1,5);
INSERT INTO ROOM_FACILITY VALUES(6,1,27);
INSERT INTO ROOM_FACILITY VALUES(6,1,6);
INSERT INTO ROOM_FACILITY VALUES(6,1,7);
INSERT INTO ROOM_FACILITY VALUES(6,1,2);
INSERT INTO ROOM_FACILITY VALUES(6,1,3);
INSERT INTO ROOM_FACILITY VALUES(6,1,22);
INSERT INTO ROOM_FACILITY VALUES(6,1,4);
INSERT INTO ROOM_FACILITY VALUES(6,1,28);

INSERT INTO ROOM_FACILITY VALUES(6,2,19);
INSERT INTO ROOM_FACILITY VALUES(6,2,5);
INSERT INTO ROOM_FACILITY VALUES(6,2,27);
INSERT INTO ROOM_FACILITY VALUES(6,2,6);
INSERT INTO ROOM_FACILITY VALUES(6,2,7);
INSERT INTO ROOM_FACILITY VALUES(6,2,2);
INSERT INTO ROOM_FACILITY VALUES(6,2,3);
INSERT INTO ROOM_FACILITY VALUES(6,2,22);
INSERT INTO ROOM_FACILITY VALUES(6,2,4);
INSERT INTO ROOM_FACILITY VALUES(6,2,28);

INSERT INTO ROOM_FACILITY VALUES(6,3,19);
INSERT INTO ROOM_FACILITY VALUES(6,3,5);
INSERT INTO ROOM_FACILITY VALUES(6,3,27);
INSERT INTO ROOM_FACILITY VALUES(6,3,6);
INSERT INTO ROOM_FACILITY VALUES(6,3,7);
INSERT INTO ROOM_FACILITY VALUES(6,3,2);
INSERT INTO ROOM_FACILITY VALUES(6,3,3);
INSERT INTO ROOM_FACILITY VALUES(6,3,22);
INSERT INTO ROOM_FACILITY VALUES(6,3,4);
INSERT INTO ROOM_FACILITY VALUES(6,3,28);

--!ADD ROOM SERVICE
INSERT INTO ROOM_SERVICE VALUES(6,1,1);
INSERT INTO ROOM_SERVICE VALUES(6,1,8);
INSERT INTO ROOM_SERVICE VALUES(6,1,14);
INSERT INTO ROOM_SERVICE VALUES(6,1,3);
INSERT INTO ROOM_SERVICE VALUES(6,1,5);

INSERT INTO ROOM_SERVICE VALUES(6,2,1);
INSERT INTO ROOM_SERVICE VALUES(6,2,8);
INSERT INTO ROOM_SERVICE VALUES(6,2,14);
INSERT INTO ROOM_SERVICE VALUES(6,2,3);
INSERT INTO ROOM_SERVICE VALUES(6,2,5);

INSERT INTO ROOM_SERVICE VALUES(6,3,1);
INSERT INTO ROOM_SERVICE VALUES(6,3,8);
INSERT INTO ROOM_SERVICE VALUES(6,3,14);
...
INSERT INTO ROOM_TYPE VALUES(7, 3, N'Phòng Superior Giường Đôi', 3, 25, 600000,
	...
	'DOUBLE');
--!ADD ROOM FACILITY
INSERT INTO ROOM_FACILITY VALUES(7,1,5);
INSERT INTO ROOM_FACILITY VALUES(7,1,7);
INSERT INTO ROOM_FACILITY VALUES(7,1,22);
INSERT INTO ROOM_FACILITY VALUES(7,1,4);
INSERT INTO ROOM_FACILITY VALUES(7,1,10);
INSERT INTO ROOM_FACILITY VALUES(7,1,9);
INSERT INTO ROOM_FACILITY VALUES(7,1,24);

INSERT INTO ROOM_FACILITY VALUES(7,2,5);
INSERT INTO ROOM_FACILITY VALUES(7,2,7);
INSERT INTO ROOM_FACILITY VALUES(7,2,22);
INSERT INTO ROOM_FACILITY VALUES(7,2,4);
INSERT INTO ROOM_FACILITY VALUES(7,2,10);
INSERT INTO ROOM_FACILITY VALUES(7,2,9);
INSERT INTO ROOM_FACILITY VALUES(7,2,24);

INSERT INTO ROOM_FACILITY VALUES(7,3,5);
INSERT INTO ROOM_FACILITY VALUES(7,3,7);
INSERT INTO ROOM_FACILITY VALUES(7,3,22);
INSERT INTO ROOM_FACILITY VALUES(7,3,4);
INSERT INTO ROOM_FACILITY VALUES(7,3,10);
INSERT INTO ROOM_FACILITY VALUES(7,3,9);
INSERT INTO ROOM_FACILITY VALUES(7,3,24);

--!ADD ROOM SERVICE
INSERT INTO ROOM_SERVICE VALUES(7,1,8);
INSERT INTO ROOM_SERVICE VALUES(7,1,11);
INSERT INTO ROOM_SERVICE VALUES(7,1,14);

INSERT INTO ROOM_SERVICE VALUES(7,2,8);
INSERT INTO ROOM_SERVICE VALUES(7,2,11);
INSERT INTO ROOM_SERVICE VALUES(7,2,14);

INSERT INTO ROOM_SERVICE VALUES(7,3,8);
INSERT INTO ROOM_SERVICE VALUES(7,3,11);
INSERT INTO ROOM_SERVICE VALUES(7,3,14);
...
INSERT INTO ROOM_FACILITY VALUES (8,1,22);
INSERT INTO ROOM_FACILITY VALUES (8,1,9);
INSERT INTO ROOM_FACILITY VALUES (8,1,10);
...
INSERT INTO ROOM_FACILITY VALUES (8,2,22);
INSERT INTO ROOM_FACILITY VALUES (8,2,9);
INSERT INTO ROOM_FACILITY VALUES (8,2,10);
...
INSERT INTO ROOM_FACILITY VALUES (8,3,22);
INSERT INTO ROOM_FACILITY VALUES (8,3,9);
INSERT INTO ROOM_FACILITY VALUES (8,3,10);

--! ADD ROOM SERVICE
INSERT INTO ROOM_SERVICE VALUES(8,1,4);
INSERT INTO ROOM_SERVICE VALUES(8,1,5);
INSERT INTO ROOM_SERVICE VALUES(8,1,6);
INSERT INTO ROOM_SERVICE VALUES(8,1,8);

INSERT INTO ROOM_SERVICE VALUES(8,2,4);
INSERT INTO ROOM_SERVICE VALUES(8,2,5);
INSERT INTO ROOM_SERVICE VALUES(8,2,6);
INSERT INTO ROOM_SERVICE VALUES(8,2,8);

INSERT INTO ROOM_SERVICE VALUES(8,3,4);
INSERT INTO ROOM_SERVICE VALUES(8,3,5);
INSERT INTO ROOM_SERVICE VALUES(8,3,6);
INSERT INTO ROOM_SERVICE VALUES(8,3,8);
...
INSERT INTO ROOM_FACILITY VALUES(9,1,17);
INSERT INTO ROOM_FACILITY VALUES(9,1,22);
INSERT INTO ROOM_FACILITY VALUES(9,1,30);
INSERT INTO ROOM_FACILITY VALUES(9,1,9);
INSERT INTO ROOM_FACILITY VALUES(9,1,10);
INSERT INTO ROOM_FACILITY VALUES(9,1,31);
INSERT INTO ROOM_FACILITY VALUES(9,1,26);

INSERT INTO ROOM_FACILITY VALUES(9,2,1);
INSERT INTO ROOM_FACILITY VALUES(9,2,2);
INSERT INTO ROOM_FACILITY VALUES(9,2,3);
INSERT INTO ROOM_FACILITY VALUES(9,2,17);
INSERT INTO ROOM_FACILITY VALUES(9,2,22);
INSERT INTO ROOM_FACILITY VALUES(9,2,30);
INSERT INTO ROOM_FACILITY VALUES(9,2,9);
INSERT INTO ROOM_FACILITY VALUES(9,2,10);
INSERT INTO ROOM_FACILITY VALUES(9,2,31);
INSERT INTO ROOM_FACILITY VALUES(9,2,26);

INSERT INTO ROOM_FACILITY VALUES(9,3,1);
INSERT INTO ROOM_FACILITY VALUES(9,3,2);
INSERT INTO ROOM_FACILITY VALUES(9,3,3);
INSERT INTO ROOM_FACILITY VALUES(9,3,17);
INSERT INTO ROOM_FACILITY VALUES(9,3,22);
INSERT INTO ROOM_FACILITY VALUES(9,3,30);
INSERT INTO ROOM_FACILITY VALUES(9,3,9);
INSERT INTO ROOM_FACILITY VALUES(9,3,10);
INSERT INTO ROOM_FACILITY VALUES(9,3,31);
INSERT INTO ROOM_FACILITY VALUES(9,3,26);
--!ADD ROOM SERVICE
INSERT INTO ROOM_SERVICE VALUES(9,1,7);
INSERT INTO ROOM_SERVICE VALUES(9,1,8);
INSERT INTO ROOM_SERVICE VALUES(9,1,14);
INSERT INTO ROOM_SERVICE VALUES(9,1,5);
INSERT INTO ROOM_SERVICE VALUES(9,1,13);

INSERT INTO ROOM_SERVICE VALUES(9,2,7);
INSERT INTO ROOM_SERVICE VALUES(9,2,8);
INSERT INTO ROOM_SERVICE VALUES(9,2,14);
INSERT INTO ROOM_SERVICE VALUES(9,2,5);

INSERT INTO ROOM_SERVICE VALUES(9,3,7);
INSERT INTO ROOM_SERVICE VALUES(9,3,8);
INSERT INTO ROOM_SERVICE VALUES(9,3,14);
INSERT INTO ROOM_SERVICE VALUES(9,3,5);
...
INSERT INTO ROOM_FACILITY VALUES(10,1,30);
INSERT INTO ROOM_FACILITY VALUES(10,1,24);
INSERT INTO ROOM_FACILITY VALUES(10,1,9);
INSERT INTO ROOM_FACILITY VALUES(10,1,26);

INSERT INTO ROOM_FACILITY VALUES(10,2,1);
INSERT INTO ROOM_FACILITY VALUES(10,2,2);
INSERT INTO ROOM_FACILITY VALUES(10,2,3);
INSERT INTO ROOM_FACILITY VALUES(10,2,10);
INSERT INTO ROOM_FACILITY VALUES(10,2,4);
INSERT INTO ROOM_FACILITY VALUES(10,2,5);
INSERT INTO ROOM_FACILITY VALUES(10,2,6);
INSERT INTO ROOM_FACILITY VALUES(10,2,7);
INSERT INTO ROOM_FACILITY VALUES(10,2,8);
INSERT INTO ROOM_FACILITY VALUES(10,2,30);
INSERT INTO ROOM_FACILITY VALUES(10,2,24);
INSERT INTO ROOM_FACILITY VALUES(10,2,9);
INSERT INTO ROOM_FACILITY VALUES(10,2,26);

INSERT INTO ROOM_FACILITY VALUES(10,3,1);
INSERT INTO ROOM_FACILITY VALUES(10,3,2);
INSERT INTO ROOM_FACILITY VALUES(10,3,3);
INSERT INTO ROOM_FACILITY VALUES(10,3,10);
INSERT INTO ROOM_FACILITY VALUES(10,3,4);
INSERT INTO ROOM_FACILITY VALUES(10,3,5);
INSERT INTO ROOM_FACILITY VALUES(10,3,6);
INSERT INTO ROOM_FACILITY VALUES(10,3,7);
INSERT INTO ROOM_FACILITY VALUES(10,3,8);
INSERT INTO ROOM_FACILITY VALUES(10,3,30);
INSERT INTO ROOM_FACILITY VALUES(10,3,24);
INSERT INTO ROOM_FACILITY VALUES(10,3,9);
INSERT INTO ROOM_FACILITY VALUES(10,3,26);

--! ADD ROOM SERVICE
INSERT INTO ROOM_SERVICE VALUES(10,1,4);
INSERT INTO ROOM_SERVICE VALUES(10,1,5);
INSERT INTO ROOM_SERVICE VALUES(10,1,6);
INSERT INTO ROOM_SERVICE VALUES(10,1,7);
INSERT INTO ROOM_SERVICE VALUES(10,1,14);

INSERT INTO ROOM_SERVICE VALUES(10,2,4);
INSERT INTO ROOM_SERVICE VALUES(10,2,5);
INSERT INTO ROOM_SERVICE VALUES(10,2,6);
INSERT INTO ROOM_SERVICE VALUES(10,2,7);
INSERT INTO ROOM_SERVICE VALUES(10,2,14);

INSERT INTO ROOM_SERVICE VALUES(10,3,4);
INSERT INTO ROOM_SERVICE VALUES(10,3,5);
INSERT INTO ROOM_SERVICE VALUES(10,3,6);
INSERT INTO ROOM_SERVICE VALUES(10,3,7);
INSERT INTO ROOM_SERVICE VALUES(10,3,14);
